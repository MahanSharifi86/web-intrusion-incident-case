...
Which account they currently control.
Which system they have compromised.
What network interfaces and addresses are available.
Whether the system provides access to additional network segments.
...
How were the WordPress credentials obtained?
How did the attacker obtain valid SSH credentials for www-data?
What was contained in backup.tar.gz?
Was the archive completely transferred to an attacker-controlled destination?
What exactly did update.sh execute?
Was shell.php created through the WordPress application, SSH access, or the downloaded payload?
How did the attacker transition from WEB-01 to PC-MANAGER and subsequently to DC-01?
